...
@foreach( $stackrs as $stackr )
	<div id='{{ $stackr->id }}' class='stackr-wrapper stackr-filterable-by-tag' tags='{{ $stackr->tags }}'>
		...
		<div class='stackr-footer'>
			...
			@endif
				<img class='stackr-link-stackr operator-image operator-image-toggable' src='{{ url( "resources/related_0.png" ) }}' relatedTo='{{ $stackr->relatedTo }}' imgName='related' state='0' />
