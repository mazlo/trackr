...
@foreach( $contexts as $context )
	...
	@if( count( $stackrs ) > 0 )
		...
		@foreach( $stackrs as $stackr )
			...
			<li>
				<div>
					<img id='stackr-relatedTo-{{ $stackr->id }}' targetStackr='{{ $stackr->id }}' class='stackr-link-stackr operator-image operator-image-toggable' src='{{ url( "resources/link_0.png" ) }}' imgName='link' state='0' style='display: table-cell; width: 23px' alt='X' />
