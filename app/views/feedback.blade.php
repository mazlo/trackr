...
@section( 'content' )
	...
	<h4 class='normal'>Thank you for using MindStackr.com. We appreciate your feedback!</h4>
	...
	<form method='post' action='{{ url("feedback") }}' accept-charset='UTF-8' autocomplete='off' class='form-default form-feedback' style='width: 460px'>
        ...
        <textarea class='textarea form' placeholder='Your opinion (optional)'></textarea>
        
        <h4>Please send an answer to (or a comment on) my feedback to</h4>

		<input placeholder='john.smith@email.com' name='email' type='text' id='email' class='textfield form'>
